...
---
*Last updated: 2026-07-04 — milestone v1.1.1: Phase 14 (Данные и структура акта) завершена — расширенные реквизиты org_settings (V033), specs из device.notes и org-реквизиты доходят до контекста рендера (DocSpec); визуальный рендер — Phase 15. Скоуп/поля/гэпы — из `.planning/PHASE-BRIEF-act-pdf-word-fidelity.md`.*
