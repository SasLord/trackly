...
regression-тестом). **Открыто:** PRIV-01 — реальные реквизиты остаются в истории git с более
ранней фазы; HEAD чист и CI-гейт добавлен, переписывание истории требует отдельной санкции
(целевая работа — Фаза 37).
