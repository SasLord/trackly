...
---
*Last updated: 2026-08-11 — **Фаза 34 «Единая шапка документов» завершена** (веха v1.3.3, 6 планов, DOC-04/05/06, 4/4 must-have, human-UAT пройден на обоих транспортах). Единый партиал `_header.html` во всех трёх печатных формах + механизм доставки шапки в уже установленные копии. Открыто: PRIV-01 (реквизиты в истории git — Фаза 37), бейдж `templates_status` добавлен сверх плана 34-05 (UI откладывался в DOC-12). Следующая фаза — 35 «Тело акта приёма-передачи».*
