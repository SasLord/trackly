...
**Success Criteria** (what must be TRUE):
  ...
  5. Поиск по актам находит совпадения по номеру, ФИО Сдал/Принял, наименованию устройства; свитч-бар Акты / Возвраты / Архив показывает корректные счётчики.**Plans:** 1/5 plans executed
...
| 3. Акты приёма-передачи и первая PDF-печать | 1/5 | In Progress|  |
