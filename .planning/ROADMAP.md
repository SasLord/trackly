...
- [ ] **Phase 6: Принтеры (SNMP-мониторинг) и Заявки** — Discovery, SNMP-опрос, Pantum hang detection (alert-only), браузер-портал заявок для сотрудников (gap-closure: human UAT 2026-06-15 нашёл дефекты заявок/discovery — см. 06-VERIFICATION.md)
...
| 6. Принтеры (SNMP-мониторинг) и Заявки | 7/7 | Gap-closure | 2026-06-15 |
