...
- [ ] 07-01-PLAN.md — Foundation: V026 org_settings migration + Phase 7 DTOs + 9 RED test scaffolds
...
- [ ] 07-04-PLAN.md — Settings UI: OrgSettings + StorageSettings + BackupSettings + ThresholdSettings + TemplateEditor (Wave 3, parallel)
...
- [ ] 07-07-PLAN.md — Wire-up: AppCtx extension + Tauri commands + axum routes + bindings.ts + human-verify checkpoint
...
| 7. Отчёты, Дашборд и Настройки | 0/7 | Not started | - |
