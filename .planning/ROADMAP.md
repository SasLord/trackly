...
- [ ] **Phase 31: Служебный AD-bind — ФИО и роли из AD-групп** - SSO-пользователи отображаются по реальному ФИО (service-account LDAP bind, с кэшем) и автоматически получают роль по членству в AD-группе.
...
| 31. Служебный AD-bind — ФИО и роли из AD-групп | v1.3 | 3/4 | In Progress|  |
