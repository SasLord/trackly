...
- [x] **Phase 33: Полировка предпросмотра печати** - Модалка предпросмотра (Акты/Приёмка/Отчёты) показывает лист A4 на сероватой подложке с полями, WYSIWYG-совпадение с реальной печатью. (completed 2026-08-04)
...
- [x] 33-04-PLAN.md — Print paths (desktop + LAN) through Paged.js (D-06) (Wave 3)
