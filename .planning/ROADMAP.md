...
| 40.3. Долг аудита v1.4 | v1.4 | 1/5 | In Progress|  |
...
- [ ] 40.3-03-PLAN.md — N-1: тост возврата использует ActDto.number напрямую + постоянный структурный гейт
- [ ] 40.3-04-PLAN.md — N-2 backend: printer IP/SNMP community в той же транзакции, что и создание устройства
- [ ] 40.3-05-PLAN.md — N-2 frontend: «Завести принтер» через DeviceFormModal (шаблоны номеров, INV-7), удаление PrinterCreateModal
