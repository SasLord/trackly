...
- [ ] 39.2-02-PLAN.md — волна 2, единственный владелец дефолтов формата пути: модуль `place_path_settings` + перевод 6 мест (WR-08)
...
- [ ] 39.2-05-PLAN.md — волна 5, экран «Формат пути»: `disabled` у кнопки (WR-06), форма `<Radio>` + новый структурный гейт (WR-07), `monoReadout` и `aria-describedby` (IN-04)
