...
- [ ] **Phase 19: Акты — дата и редактирование** - Дата «Когда отдали» сохраняется как дата акта вместо текущей даты; кнопка «Редактировать» открывает рабочую форму редактирования существующего акта. (verification: gaps_found — открыт BLOCKER CR-01)
...
| 19. Акты — дата и редактирование | v1.1.2 | 5/5 | Complete   | 2026-07-11 |
