...
- [ ] 06-05-PLAN.md — Requests UI: api.ts + 8 компонентов (RequestFormModal, RequestDetail, OperationModal REQ-05 link) (REQ-01..05/07)
...
| 6. Принтеры (SNMP-мониторинг) и Заявки | 0/6 | In progress | - |
