...
- [ ] **Phase 32: Авто-админ по списку логинов + релиз SSO в main** - Указанные доменные логины получают роль «Администратор» сразу при первом SSO-входе; спайк-ветка выходит в основной релиз.
