...
- [x] **Phase 19: Акты — дата и редактирование** - Дата «Когда отдали» сохраняется как дата акта вместо текущей даты; кнопка «Редактировать» открывает рабочую форму редактирования существующего акта. (completed 2026-07-11)
