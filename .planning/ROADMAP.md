...
2. Акт с несколькими устройствами (2+) печатает все позиции корректно в табличном виде (`ItemsTable`), включая корректный перенос длинных значений (Комплектация, Технические характеристики) без обрезки и наложения текста.
