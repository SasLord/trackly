...
## Round 3 — follow-up backlog (found 2026-06-18) — RESOLVED in quick task 260618-vtm

Phase 07 is closed/passed; these were small post-close fixes. R3-1, R3-2, R3-3
fixed and human-verified 2026-06-18 (quick task `260618-vtm`, commits 1569c28 /
19e8642). R3-4 / CR-01 intentionally WONTFIX for v1. Backlog closed.

### R3-1. Бэкапы: "Последний бэкап: Invalid Date" (frontend/DTO) — ✅ FIXED & VERIFIED
...
### R3-2. Бэкапы: schedule empty after restart (same class as GAP-S5) — ✅ FIXED & VERIFIED
...
### R3-3. CR-02: template update_body/reset_to_default swallow rows_affected — ✅ FIXED (TDD test added)
...
### R3-4. CR-01 (optional) — ⛔ WONTFIX for v1
