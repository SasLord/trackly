...
Plan: —
Status: Awaiting next milestone
Last activity: 2026-08-21 — Quick task 260821-w18: фильтр по категориям заявок в отчёте «Заявки» (кнопка-воронка + попап с 8 чекбоксами, экран/счётчики/CSV/печать, оба транспорта); ожидает живой UAT
