...
Plan: —
Status: Awaiting next milestone
Last activity: 2026-08-19 — Quick task 260819-thx: три UI-фикса в разделе «Картриджи» (дропдаун типа расходника, таблица моделей, портирование автокомплита принтеров)
