...
Last activity: 2026-08-05 - Completed quick task 260805-wik: ФИО активного AD-пользователя синхронизируется из каталога (с защитой от затирания при недоступности AD)
