...
Last activity: 2026-08-27 - Аудит v1.4 + quick 260827-gim (W1/W2) + quick 260827-rzq (падение places_list_all: sibling_cmp не полный порядок). Обе ждут живого UAT. В очереди: экспорт CSV не отдаёт файл; формат сокращения пути «начало // конец» через конфиг
