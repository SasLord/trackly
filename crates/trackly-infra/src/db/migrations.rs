...
mod tests {
    ...
    fn run_applies_all_known_migrations_on_fresh_db() {
        ...
        assert_eq!(report.schema_version, 15, "expected schema_version 15");
        assert_eq!(report.applied_count, 15, "expected 15 migrations applied");
    }

    #[test]
    fn max_known_version_returns_fifteen() {
        assert_eq!(max_known_version(), 15);
    }
