        ...
        let affected = tx
            .execute(
                ...
                rusqlite::params![
                    ...
                    patch.model.is_some() as i64,
                    patch.model.as_ref().and_then(|v| v.as_deref()),
                    patch.state.is_some() as i64,
                    patch.state.as_ref().and_then(|v| v.as_deref()),
                    patch.kit.is_some() as i64,
                    patch.kit.as_ref().and_then(|v| v.as_deref()),
                    patch.place_id.is_some() as i64,
                    patch.place_id.flatten(),
                    patch.status_id,
                    patch.specs.is_some() as i64,
                    patch.specs.as_ref().and_then(|v| v.as_deref()),
                    now_utc,
                    id,
                    version,
                ],
