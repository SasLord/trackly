...
pub mod number_templates_sqlite;
pub mod place_movements_sqlite;
...
pub use number_templates_sqlite::SqliteNumberTemplateRepository;
pub use place_movements_sqlite::SqlitePlaceMovementsRepository;
pub use places_sqlite::SqlitePlaceRepository;
