...
async fn do_return_for(
    ...
    svc.do_return(
        ...
        ActReturnDto {
            ...
            bulk_location_id: Some(location_id),
...
async fn retained_edit_changes_device_condition_location() {
    tokio::time::timeout(Duration::from_secs(30), async {
        ...
        assert_eq!(post.location_id, Some(loc_c), "location updated");
...
async fn allow_edit_when_device_untouched() {
    tokio::time::timeout(Duration::from_secs(30), async {
        ...
        assert_eq!(post.location_id, Some(loc_b));
    })
    .await
